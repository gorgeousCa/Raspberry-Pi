 - 使用Windows自带的远程桌面连接
        ...
        （2） 再安装xrdp服务。
         ...
         如出现以下画面，可使用 netstat tnl 查看端口3350 3389 5910 这    三个端口处于LISTEN
...
（1）确认树莓派SSH打开
 ...
 （2）在Windows电脑上下载putty.exe。,并打开（如上图所示）
